...
<br>
	<div class="container">
		...
		<?php
		 ...
		 // bütün kayıtları seç
		 $sorgu = "SELECT*FROM personel ORDER BY id ASC";
...
class='glyphicon glyphicon glyphicon-remove-circle'></span> Sil</a>";
		 ...
		 echo "<a href='personel-ekle.php' class='btn btn-primary m-b-1em'>Yeni Personel Ekle</a>";
	...
	<script type='text/javascript'>
	 ...
	 window.location = 'personel-sil.php?id=' + id;
	 }
	 }
</script>
