...
<div class="container">
	...
	<div class="row"> 
		...
		$sonid = $id;
		echo "<a href='urun-servis-ekle.php?id={$id}' class='btn btn-success'>Yeni Servis Kaydı Ekle</a>";
		?>
				...
				echo "</tr>";
 					...
 					// $kayit['urunadi'] => $urunadi
 						...
 						echo "<tr>";
							...
							echo "<td> <a href='servis-duzenle.php?id={$id}' class='btn btn-success'>Düzenle</a>
							
							<a href='#' onclick='silme_onay({$id});' class='btn btn-danger'> Sil</a>
