  ...
  <div class="panel-body">
       ...
       <div class="container">
		  ...
		  $ilk_kayit_no = ($sayfa_kayit_sayisi * $sayfa) - $sayfa_kayit_sayisi;
            ...
            $sorgu = ("SELECT urunler.id, urunler.marka, urunler.model, urunler.seri, urunler.demirbas, urunler.firma, urunler.calisma, durum.adi FROM urunler LEFT JOIN durum ON urunler.durum_id = durum.id WHERE urunler.kategori_id = ".$url." AND urunler.seri LIKE :aranan ORDER BY urunler.id ASC LIMIT :ilk_kayit_no, :sayfa_kayit_sayisi");
